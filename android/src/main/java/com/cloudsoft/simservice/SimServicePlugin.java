    ...
    try {
      ...
      if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP_MR1) {
        ...
        activeSubscriptionInfoCount =
            subscriptionManager != null ? subscriptionManager.getActiveSubscriptionInfoCount() : 0;
        activeSubscriptionInfoCountMax =
            subscriptionManager != null ? subscriptionManager.getActiveSubscriptionInfoCountMax()
                : 0;
